...
public class AutorTest {
    ...
    @Test
public void testAutorNaoEhUsuarioPorPadrao() {
    Autor autorSimples = new Autor("Jess", "Brasileira");
    assertFalse(autorSimples.isEhUsuario());
}

@Test
public void testAutorEhUsuario() {
    Autor autorComFlag = new Autor("Alan Turing", "Inglês", true);
    assertTrue(autorComFlag.isEhUsuario());
}

@Test
public void testSetEhUsuario() {
